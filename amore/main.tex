...
\begin{frame}
    ...
    \input{figures/costs-histogram.tex}
\end{frame}

\begin{frame}
    \frametitle{Pairing Delegation}
    \input{figures/delegation-framework.tex}
\end{frame}

\begin{frame}
    \input{figures/amore-flow.tex}
\end{frame}
...
\]
    ...
    \]
	% \item \textbf{Input privacy}: For applications handling sensitive data, the \server should learn no information about the \client's pairing inputs beyond what is revealed by the protocol's output.
    \end{itemize}
\end{frame}

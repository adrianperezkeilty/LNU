...
\Z_q^*\,$ and $u\pick\Z_q^*\,$. Let $U=[u]P\in\Group\,$, and consider the public view 
	\begin{equation}
	...
	\begin{equation}
		\forge{U}\in\mathcal{I}=\left\{[t_1^{-1}](\CC-\XX)\colon t_1\in S\right\}\cap
...
\begin{frame}
    \frametitle{Meet-in-the-middle attack}
    \input{figures/meet-in-the-middle.tex}
\end{frame}

\begin{frame}
    \frametitle{Meet-in-the-middle attack}
    \input{figures/double-DES.tex}
\end{frame}
